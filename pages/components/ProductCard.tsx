function Product({
    ...
    return (
        <div className="group flex p-3 w-full sm:w-1/2 md:w-1/3 xl:w-1/4 hover:transform  hover:scale-105 duration-200">
            <div className="flex w-full hover:border-oma-shock border-2 border-transparent rounded-3xl dark:bg-slate-500" >
                <div className="w-2/5 p-1 overflow-hidden rounded-l-3xl dark:bg-white">
                    <div style={{ backgroundImage: `url(${image})` }}
                        className="bg-contain bg-no-repeat bg-center w-full h-full hover:transform group-hover:scale-150 duration-300"
                    ></div>
                </div>
                ...
                <div className="w-3/5 p-2 ">
                    ...
                    <button className="bg-transparent hover:bg-oma-dark text-slate-900
                     font-semibold hover:text-oma-light py-2 px-4 border border-slate-900 
                    ...
                    <div className="text-oma-light pl-2 pt-2">{description.substr(0, 70)}</div>
                </div>
            </div>
        </div>
    );
